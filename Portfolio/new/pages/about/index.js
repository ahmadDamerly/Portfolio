...
const about = () => {
  ...
  return (
    <div className='h-full bg-[#3b2d71] py-32 text-center xl:text-left'>
        {/* <Circles/> */}
        {/* <motion.div 
        ...
        <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'> 
            ...
            animate='show'
            exit='hidden' 
            className='h2'>Captivating <span className='text-red-600'>stories </span>birth magnificent designs.</motion.h2>
            <motion.p
            variants={fadeIn('right', 0.4)}
            initial='hidden'
            animate='show'
            exit='hidden'
            className='max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0'>10 years ago, I began 
            freelancin as a developer. Since then , I have done remote work for agencies consulted for 
            startup and collaborated on digital products for business and consumers use.
            </motion.p>
            ...
            className='flex flex-col w-full xl:max-w-[48%] h-[480px] '>
                <div className='flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-4 xl:mt-[50px] '>
                    ...
                    {aboutData[index].info.map((item , itemIndex) => {
                        return (
                            ...
                            gap-x-2 items-center text-white/60'>
                                <div  className='font-lightmb-2  md:mb-0'>{item.title} </div>
